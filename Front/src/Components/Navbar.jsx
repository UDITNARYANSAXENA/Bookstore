                ...
                <div className="navbar">
                    ...
                    <div className='navbar-end space-x-3'>
                        ...
                        <div className="hidden md:block">
                            <label className=" px-3 py-1 border flex rounded-md items-center gap-2 ">
                        ...
                        <div className="">
                            <button type="button" className="bg-black text-white px-3 py-2 rounded hover:bg-slate-800 duration-300 cursor-pointer" onClick={handleLoginClick}>
                                Login
                            </button>
                        </div>
                    </div>
